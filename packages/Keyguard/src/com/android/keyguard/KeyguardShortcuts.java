...
public class KeyguardShortcuts extends LinearLayout {
    ...
    private void createShortcuts() {
        ...
        boolean longpress = Settings.PAC.getIntForUser(mContext.getContentResolver(),
                Settings.PAC.LOCKSCREEN_SHORTCUTS_LONGPRESS, 1, UserHandle.USER_CURRENT) == 1;
    ...
    class SettingsObserver extends ContentObserver {
        ...
        void observe() {
            mContext.getContentResolver().registerContentObserver(Settings.PAC.getUriFor(
                    Settings.PAC.LOCKSCREEN_SHORTCUTS),
