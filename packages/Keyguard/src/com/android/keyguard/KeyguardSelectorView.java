    ...
    protected void onFinishInflate() {
        ...
        mDoubleTapGesture = new GestureDetector(mContext,
            ...
            public boolean onDoubleTap(MotionEvent e) {
                int doubletapoption = Settings.PAC.getInt(mContext.getContentResolver(), Settings.PAC.LOCKSCREEN_GLOWPAD_DOUBLETAP_OPTION, 0);
        ...
        if (Settings.PAC.getInt(mContext.getContentResolver(),
                    Settings.PAC.DOUBLE_TAP_GLOWPAD_GESTURE, 0) == 1) {
