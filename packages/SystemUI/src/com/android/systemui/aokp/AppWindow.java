...
public class AppWindow extends LinearLayout implements OnItemClickListener, OnItemLongClickListener {
    ...
    class SettingsObserver extends ContentObserver {
        ...
        void observe() {
            ...
            resolver.registerContentObserver(Settings.System.getUriFor(
                    Settings.System.APP_WINDOW[AokpRibbonHelper.WINDOW_COLOR]), false, this);
            resolver.registerContentObserver(Settings.System.getUriFor(
                    Settings.System.APP_WINDOW[AokpRibbonHelper.WINDOW_SIZE]), false, this);
            resolver.registerContentObserver(Settings.System.getUriFor(
                    Settings.System.APP_WINDOW[AokpRibbonHelper.WINDOW_SPACE]), false, this);
            resolver.registerContentObserver(Settings.System.getUriFor(
                    Settings.System.APP_WINDOW[AokpRibbonHelper.WINDOW_ANIMATION]), false, this);
            resolver.registerContentObserver(Settings.System.getUriFor(
                    Settings.System.APP_WINDOW[AokpRibbonHelper.WINDOW_ANIMATION_DURATION]), false, this);
        }
         @Override
    ...
    protected void updateSettings() {
        ...
        mColor = Settings.System.getInt(cr, Settings.System.APP_WINDOW[AokpRibbonHelper.WINDOW_COLOR], Color.BLACK);
        mAnimDur = Settings.System.getInt(cr, Settings.System.APP_WINDOW[AokpRibbonHelper.WINDOW_ANIMATION_DURATION], 50);
        mAnim = Settings.System.getInt(cr, Settings.System.APP_WINDOW[AokpRibbonHelper.WINDOW_ANIMATION], 0);
        int size = Settings.System.getInt(cr, Settings.System.APP_WINDOW[AokpRibbonHelper.WINDOW_SIZE], 30);
        mSize = (int) (((size * 0.01f) * 150) + 150);
        int margin = Settings.System.getInt(cr, Settings.System.APP_WINDOW[AokpRibbonHelper.WINDOW_SPACE], 5);
