...
public class RibbonGestureCatcherView extends LinearLayout {
    ...
    protected void updateSettings() {
        ...
        mDragButtonColor = Settings.System.getInt(cr, SETTINGS_SYSTEM[AokpRibbonHelper.HANDLE_COLOR], Color.TRANSPARENT);
        mButtonWeight = Settings.System.getInt(cr, SETTINGS_SYSTEM[AokpRibbonHelper.HANDLE_WEIGHT], 30);
        mButtonHeight = Settings.System.getInt(cr, SETTINGS_SYSTEM[AokpRibbonHelper.HANDLE_HEIGHT], 50);
        mLongSwipeAction = Settings.System.getString(cr, SETTINGS_SYSTEM[AokpRibbonHelper.LONG_SWIPE]);
        if (TextUtils.isEmpty(mLongSwipeAction)) {
            mLongSwipeAction = AwesomeConstant.ACTION_APP_WINDOW.value();
            Settings.System
                    .putString(cr, SETTINGS_SYSTEM[AokpRibbonHelper.LONG_SWIPE], AwesomeConstant.ACTION_APP_WINDOW.value());
        }
        mLongPressAction = Settings.System.getString(cr, SETTINGS_SYSTEM[AokpRibbonHelper.LONG_PRESS]);
        if (TextUtils.isEmpty(mLongPressAction)) {
            mLongPressAction = AwesomeConstant.ACTION_APP_WINDOW.value();
            Settings.System
                    .putString(cr, SETTINGS_SYSTEM[AokpRibbonHelper.LONG_PRESS], AwesomeConstant.ACTION_APP_WINDOW.value());
        }
        vib = Settings.System.getBoolean(cr, SETTINGS_SYSTEM[AokpRibbonHelper.HANDLE_VIBRATE], true);
        mLocation = Settings.System.getInt(cr, SETTINGS_SYSTEM[AokpRibbonHelper.HANDLE_LOCATION], 0);
        updateLayout();
    }
}
