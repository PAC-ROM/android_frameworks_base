...
public class AokpSwipeRibbon extends LinearLayout implements OnItemClickListener, OnItemLongClickListener {
    ...
    private String[] SETTINGS_SYSTEM;
    ...
    public AokpSwipeRibbon(Context context, String location) {
        ...
        SETTINGS_SYSTEM = mLocation.equals("left") ? Settings.System.AOKP_LEFT_RIBBON : Settings.System.AOKP_RIGHT_RIBBON;
    ...
    public void createRibbonView() {
        ...
        if (!mEnabled) return;
        mGesturePanel = new RibbonGestureCatcherView(mContext, mLocation, SETTINGS_SYSTEM, this);
    ...
    class SettingsObserver extends ContentObserver {
        ...
        void observe() {
            ...
            resolver.registerContentObserver(Settings.System.getUriFor(SETTINGS_SYSTEM[AokpRibbonHelper.ENABLE_RIBBON]), false, this);
            resolver.registerContentObserver(Settings.System.getUriFor(SETTINGS_SYSTEM[AokpRibbonHelper.RIBBON_ITEMS]), false, this);
            resolver.registerContentObserver(Settings.System.getUriFor(SETTINGS_SYSTEM[AokpRibbonHelper.LONG_SWIPE]), false, this);
            resolver.registerContentObserver(Settings.System.getUriFor(SETTINGS_SYSTEM[AokpRibbonHelper.HANDLE_HEIGHT]), false, this);
            resolver.registerContentObserver(Settings.System.getUriFor(SETTINGS_SYSTEM[AokpRibbonHelper.HANDLE_LOCATION]), false, this);
            resolver.registerContentObserver(Settings.System.getUriFor(SETTINGS_SYSTEM[AokpRibbonHelper.HANDLE_COLOR]), false, this);
            resolver.registerContentObserver(Settings.System.getUriFor(SETTINGS_SYSTEM[AokpRibbonHelper.HANDLE_VIBRATE]), false, this);
            resolver.registerContentObserver(Settings.System.getUriFor(SETTINGS_SYSTEM[AokpRibbonHelper.HANDLE_WEIGHT]), false, this);
            resolver.registerContentObserver(Settings.System.getUriFor(SETTINGS_SYSTEM[AokpRibbonHelper.LONG_PRESS]), false, this);
            resolver.registerContentObserver(Settings.System.getUriFor(SETTINGS_SYSTEM[AokpRibbonHelper.AUTO_HIDE_DURATION]), false, this);
            resolver.registerContentObserver(Settings.System.getUriFor(SETTINGS_SYSTEM[AokpRibbonHelper.RIBBON_COLOR]), false, this);
            resolver.registerContentObserver(Settings.System.getUriFor(SETTINGS_SYSTEM[AokpRibbonHelper.RIBBON_ANIMATION_DURATION]), false, this);
            resolver.registerContentObserver(Settings.System.getUriFor(SETTINGS_SYSTEM[AokpRibbonHelper.RIBBON_ANIMATION_TYPE]), false, this);
            resolver.registerContentObserver(Settings.System.getUriFor(SETTINGS_SYSTEM[AokpRibbonHelper.RIBBON_MARGIN]), false, this);
            resolver.registerContentObserver(Settings.System.getUriFor(SETTINGS_SYSTEM[AokpRibbonHelper.RIBBON_SIZE]), false, this);
            resolver.registerContentObserver(Settings.System.getUriFor(SETTINGS_SYSTEM[AokpRibbonHelper.RIBBON_ICON_GRAVITY]), false, this);
        }
         @Override
   ...
   protected void updateSettings() {
        ...
        mEnabled = Settings.System.getBoolean(cr, SETTINGS_SYSTEM[AokpRibbonHelper.ENABLE_RIBBON], false);
        mItems.clear();
        ArrayList<String> list = Settings.System.getArrayList(cr, SETTINGS_SYSTEM[AokpRibbonHelper.RIBBON_ITEMS]);
        for (String item : list) {
            mItems.add(new RibbonItem(item));
        }
        mGravity = Settings.System.getInt(cr, SETTINGS_SYSTEM[AokpRibbonHelper.RIBBON_ICON_GRAVITY], 0);
        mHideTimeOut = Settings.System.getInt(cr, SETTINGS_SYSTEM[AokpRibbonHelper.AUTO_HIDE_DURATION], 0);
        mRibbonColor = Settings.System.getInt(cr, SETTINGS_SYSTEM[AokpRibbonHelper.RIBBON_COLOR], Color.BLACK);
        mAnim = Settings.System.getInt(cr, SETTINGS_SYSTEM[AokpRibbonHelper.RIBBON_ANIMATION_TYPE], 0);
        mAnimDur = Settings.System.getInt(cr, SETTINGS_SYSTEM[AokpRibbonHelper.RIBBON_ANIMATION_DURATION], 50);
        int size = Settings.System.getInt(mContext.getContentResolver(), SETTINGS_SYSTEM[AokpRibbonHelper.RIBBON_SIZE], 30);
        mWidth = (int) (((size * 0.01f) * 150) + 125);
        int margin = Settings.System.getInt(mContext.getContentResolver(), SETTINGS_SYSTEM[AokpRibbonHelper.RIBBON_MARGIN], 5);
