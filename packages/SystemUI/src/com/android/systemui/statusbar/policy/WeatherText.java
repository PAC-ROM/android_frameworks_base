...
public class WeatherText extends TextView {
    ...
    protected void onAttachedToWindow() {
        ...
        if (!mAttached) {
            mAttached = true;
            IntentFilter filter = new IntentFilter("com.pac.INTENT_WEATHER_UPDATE");
    ...
    class SettingsObserver extends ContentObserver {
        ...
        void observe() {
            ...
            resolver.registerContentObserver(
                    Settings.PAC.getUriFor(Settings.PAC.USE_WEATHER), false,
                    this);
            resolver.registerContentObserver(
                    Settings.PAC.getUriFor(Settings.PAC.WEATHER_SHOW_LOCATION), false,
                    this);
            resolver.registerContentObserver(
                    Settings.PAC.getUriFor(Settings.PAC.STATUSBAR_WEATHER_STYLE), false,
                    this);
            updateSettings();
        }
    ...
    protected void updateSettings() {
        ContentResolver resolver = mContext.getContentResolver();
        boolean useWeather = (Settings.PAC.getBoolean(resolver, Settings.PAC.USE_WEATHER, false)
                && Settings.PAC.getInt(resolver, Settings.PAC.STATUSBAR_WEATHER_STYLE, 1) == 0);
        mShowLocation = Settings.PAC.getBoolean(resolver, Settings.PAC.WEATHER_SHOW_LOCATION, true);
