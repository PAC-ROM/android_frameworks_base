...
public class NetworkTraffic extends TextView {
    ...
    class SettingsObserver extends ContentObserver {
        ...
        void observe() {
            ...
            resolver.registerContentObserver(Settings.PAC
                    ...
                    this, UserHandle.USER_ALL);
            resolver.registerContentObserver(Settings.PAC
                    .getUriFor(Settings.PAC.NETWORK_TRAFFIC_AUTOHIDE_THRESHOLD), false,
                    this, UserHandle.USER_ALL);
            resolver.registerContentObserver(Settings.PAC
                    .getUriFor(Settings.PAC.NETWORK_TRAFFIC_COLOR), false,
                    this, UserHandle.USER_ALL);
        }
    ...
    private void updateSettings() {
        ...
        mAutoHide = Settings.PAC.getIntForUser(resolver,
                Settings.PAC.NETWORK_TRAFFIC_AUTOHIDE, 0,
                UserHandle.USER_CURRENT) == 1;

        mAutoHideThreshold = Settings.PAC.getIntForUser(resolver,
