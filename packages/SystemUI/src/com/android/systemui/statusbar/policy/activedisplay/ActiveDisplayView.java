...
import com.android.internal.util.pac.QuietHoursHelper;
    ...
    private class SettingsObserver extends ContentObserver {
        ...
        void observe() {
            ...
            resolver.registerContentObserver(Settings.PAC.getUriFor(
                    Settings.PAC.ENABLE_ACTIVE_DISPLAY), false, this);
            resolver.registerContentObserver(Settings.PAC.getUriFor(
                    Settings.PAC.ACTIVE_DISPLAY_TEXT), false, this);
            resolver.registerContentObserver(Settings.PAC.getUriFor(
                    Settings.PAC.ACTIVE_DISPLAY_ALL_NOTIFICATIONS), false, this);
            resolver.registerContentObserver(Settings.PAC.getUriFor(
                    Settings.PAC.ACTIVE_DISPLAY_HIDE_LOW_PRIORITY_NOTIFICATIONS), false, this);
            resolver.registerContentObserver(Settings.PAC.getUriFor(
                    Settings.PAC.ACTIVE_DISPLAY_POCKET_MODE), false, this);
            resolver.registerContentObserver(Settings.PAC.getUriFor(
                    Settings.PAC.ACTIVE_DISPLAY_REDISPLAY), false, this);
            resolver.registerContentObserver(Settings.PAC.getUriFor(
                    Settings.PAC.ACTIVE_DISPLAY_BRIGHTNESS), false, this);
            resolver.registerContentObserver(Settings.PAC.getUriFor(
                    Settings.PAC.ACTIVE_DISPLAY_SUNLIGHT_MODE), false, this);
            resolver.registerContentObserver(Settings.PAC.getUriFor(
            ...
            resolver.registerContentObserver(Settings.PAC.getUriFor(
                    Settings.PAC.ACTIVE_DISPLAY_TURNOFF_MODE), false, this);
            resolver.registerContentObserver(Settings.PAC.getUriFor(
                    Settings.PAC.ACTIVE_DISPLAY_THRESHOLD), false, this);
            resolver.registerContentObserver(Settings.PAC.getUriFor(
                    Settings.PAC.ACTIVE_DISPLAY_CONTENT), false, this);
            resolver.registerContentObserver(Settings.PAC.getUriFor(
                    Settings.PAC.ACTIVE_DISPLAY_BYPASS), false, this);
            resolver.registerContentObserver(Settings.PAC.getUriFor(
                    Settings.PAC.BATTERY_AROUND_LOCKSCREEN_RING), false, this);
            resolver.registerContentObserver(Settings.System.getUriFor(
                    Settings.System.STATUS_BAR_NOTIF_COUNT), false, this);
            resolver.registerContentObserver(Settings.PAC.getUriFor(
                    Settings.PAC.ACTIVE_DISPLAY_ANNOYING), false, this);
            resolver.registerContentObserver(Settings.PAC.getUriFor(
                    Settings.PAC.ACTIVE_DISPLAY_DOUBLE_TAP), false, this);
            resolver.registerContentObserver(Settings.PAC.getUriFor(
                    Settings.PAC.ACTIVE_DISPLAY_SHAKE_EVENT), false, this);
            resolver.registerContentObserver(Settings.PAC.getUriFor(
                    Settings.PAC.ACTIVE_DISPLAY_SHAKE_FORCE), false, this);
            resolver.registerContentObserver(Settings.PAC.getUriFor(
                    Settings.PAC.ACTIVE_DISPLAY_SHAKE_QUITE_HOURS), false, this);
            resolver.registerContentObserver(Settings.PAC.getUriFor(
                    Settings.PAC.ACTIVE_DISPLAY_SHAKE_THRESHOLD), false, this);
            resolver.registerContentObserver(Settings.PAC.getUriFor(
                    Settings.PAC.ACTIVE_DISPLAY_SHAKE_LONGTHRESHOLD), false, this);
            resolver.registerContentObserver(Settings.PAC.getUriFor(
                    Settings.PAC.ACTIVE_DISPLAY_SHAKE_TIMEOUT), false, this);
            update();
        }
        ...
        public void update() {
            ...
            mActiveDisplayEnabled = Settings.PAC.getIntForUser(
                    resolver, Settings.PAC.ENABLE_ACTIVE_DISPLAY, 0,
                    UserHandle.USER_CURRENT_OR_SELF) == 1;
            mDisplayNotificationText = Settings.PAC.getIntForUser(
                    resolver, Settings.PAC.ACTIVE_DISPLAY_TEXT, 0,
                    UserHandle.USER_CURRENT_OR_SELF) == 1;
            mShowAllNotifications = Settings.PAC.getIntForUser(
                    resolver, Settings.PAC.ACTIVE_DISPLAY_ALL_NOTIFICATIONS, 0,
                    UserHandle.USER_CURRENT_OR_SELF) == 1;
            mHideLowPriorityNotifications = Settings.PAC.getIntForUser(
                    resolver, Settings.PAC.ACTIVE_DISPLAY_HIDE_LOW_PRIORITY_NOTIFICATIONS, 0,
                    UserHandle.USER_CURRENT_OR_SELF) == 1;
            mPocketMode = Settings.PAC.getIntForUser(
                    resolver, Settings.PAC.ACTIVE_DISPLAY_POCKET_MODE, POCKET_MODE_OFF,
                    UserHandle.USER_CURRENT_OR_SELF);
            mRedisplayTimeout = Settings.PAC.getLongForUser(
                    resolver, Settings.PAC.ACTIVE_DISPLAY_REDISPLAY, 0L,
                    UserHandle.USER_CURRENT_OR_SELF);
            mInitialBrightness = Settings.PAC.getIntForUser(
                    resolver, Settings.PAC.ACTIVE_DISPLAY_BRIGHTNESS, mMaximumBacklight,
                    UserHandle.USER_CURRENT_OR_SELF);
            mSunlightModeEnabled = Settings.PAC.getIntForUser(
                    resolver, Settings.PAC.ACTIVE_DISPLAY_SUNLIGHT_MODE, 0,
                    UserHandle.USER_CURRENT_OR_SELF) == 1;
            String excludedApps = Settings.PAC.getStringForUser(resolver,
                    Settings.PAC.ACTIVE_DISPLAY_EXCLUDED_APPS,
                    UserHandle.USER_CURRENT_OR_SELF);
            String privacyApps = Settings.PAC.getStringForUser(resolver,
                    Settings.PAC.ACTIVE_DISPLAY_PRIVACY_APPS,
                    UserHandle.USER_CURRENT_OR_SELF);
            mDisplayTimeout = Settings.PAC.getLongForUser(
                    resolver, Settings.PAC.ACTIVE_DISPLAY_TIMEOUT, mDisplayTimeout,
                    UserHandle.USER_CURRENT_OR_SELF);
            mTurnOffModeEnabled = Settings.PAC.getIntForUser(
                    resolver, Settings.PAC.ACTIVE_DISPLAY_TURNOFF_MODE, 0,
                    UserHandle.USER_CURRENT_OR_SELF) == 1;
            mProximityThreshold = Settings.PAC.getLongForUser(
                    resolver, Settings.PAC.ACTIVE_DISPLAY_THRESHOLD, mProximityThreshold,
                    UserHandle.USER_CURRENT_OR_SELF);
            mUseActiveDisplayContent = Settings.PAC.getIntForUser(
                    resolver, Settings.PAC.ACTIVE_DISPLAY_CONTENT, 1,
                    UserHandle.USER_CURRENT_OR_SELF) != 0;
            mBypassActiveDisplay = Settings.PAC.getIntForUser(
                    resolver, Settings.PAC.ACTIVE_DISPLAY_BYPASS, 1,
                    UserHandle.USER_CURRENT_OR_SELF) != 0;
            mBatteryLockscreen = Settings.PAC.getIntForUser(
                    resolver, Settings.PAC.BATTERY_AROUND_LOCKSCREEN_RING, 0,
                    UserHandle.USER_CURRENT_OR_SELF) != 0;
            mShowNotificationCount = Settings.System.getIntForUser(
                    resolver, Settings.System.STATUS_BAR_NOTIF_COUNT, 0,
                    UserHandle.USER_CURRENT_OR_SELF) != 0;
            mIsAnnoyingThreshold = Settings.PAC.getIntForUser(
                    resolver, Settings.PAC.ACTIVE_DISPLAY_ANNOYING, 0,
                    UserHandle.USER_CURRENT_OR_SELF);
            mEnableDoubleTap = Settings.PAC.getIntForUser(
                    resolver, Settings.PAC.ACTIVE_DISPLAY_DOUBLE_TAP, 0,
                    UserHandle.USER_CURRENT_OR_SELF) != 0;
            mEnableShake = Settings.PAC.getIntForUser(
                    resolver, Settings.PAC.ACTIVE_DISPLAY_SHAKE_EVENT, 0,
                    UserHandle.USER_CURRENT_OR_SELF) != 0;
            mEnableShakeForce = Settings.PAC.getIntForUser(
                    resolver, Settings.PAC.ACTIVE_DISPLAY_SHAKE_FORCE, 0,
                    UserHandle.USER_CURRENT_OR_SELF) != 0;
            mDisableShakeQuite = Settings.PAC.getIntForUser(
                    resolver, Settings.PAC.ACTIVE_DISPLAY_SHAKE_QUITE_HOURS, 0,
                    UserHandle.USER_CURRENT_OR_SELF) != 0;
            mShakeThreshold = Settings.PAC.getIntForUser(
                    resolver, Settings.PAC.ACTIVE_DISPLAY_SHAKE_THRESHOLD, mShakeThreshold,
                    UserHandle.USER_CURRENT_OR_SELF);
            mShakeLongThreshold = Settings.PAC.getIntForUser(
                    resolver, Settings.PAC.ACTIVE_DISPLAY_SHAKE_LONGTHRESHOLD, mShakeLongThreshold,
                    UserHandle.USER_CURRENT_OR_SELF);
            mShakeTimeout = Settings.PAC.getIntForUser(
                    resolver, Settings.PAC.ACTIVE_DISPLAY_SHAKE_TIMEOUT, mShakeTimeout,
                    UserHandle.USER_CURRENT_OR_SELF);
