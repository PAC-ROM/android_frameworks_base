...
public class ActiveDisplayView extends FrameLayout
    ...
    private class SettingsObserver extends ContentObserver {
        ...
        void observe() {
            ...
            resolver.registerContentObserver(Settings.PAC.getUriFor(
                    Settings.PAC.ACTIVE_DISPLAY_WALLPAPER), false, this);
            resolver.registerContentObserver(Settings.PAC.getUriFor(
        ...
        public void update() {
            ...
            mDisplayNotifications = Settings.PAC.getIntForUser(
            ...
            mDisplayTimeout = Settings.PAC.getLongForUser(
                    resolver, Settings.PAC.ACTIVE_DISPLAY_TIMEOUT, 8000L,
                    UserHandle.USER_CURRENT_OR_SELF);
            ...
            mProximityThreshold = Settings.PAC.getLongForUser(
                    resolver, Settings.PAC.ACTIVE_DISPLAY_THRESHOLD, 8000L,
                    UserHandle.USER_CURRENT_OR_SELF);
            ...
            mShowNotificationCount = Settings.System.getIntForUser(
                    ...
                    UserHandle.USER_CURRENT_OR_SELF) != 0;
            mEnableWallpaper = Settings.PAC.getIntForUser(
                    resolver, Settings.PAC.ACTIVE_DISPLAY_WALLPAPER, 0,
                    UserHandle.USER_CURRENT_OR_SELF) != 0;
