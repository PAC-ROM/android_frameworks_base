...
import com.android.systemui.pac.slimrecent.RecentController;
...
public abstract class BaseStatusBar extends SystemUI implements
    ...
    protected void updateSearchPanel() {
        ...
        if (mSearchPanelView == null) {
            ...
            boolean navbarCanMove = Settings.PAC.getIntForUser(mContext.getContentResolver(),
    ...
    protected void updateRecents() {
        boolean slimRecents = Settings.PAC.getIntForUser(mContext.getContentResolver(),
                Settings.PAC.USE_SLIM_RECENTS, 0, UserHandle.USER_CURRENT) == 1;
        if (slimRecents) {
