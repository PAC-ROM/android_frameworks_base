...
public class PhoneStatusBar extends BaseStatusBar implements DemoMode,
    ...
    class SettingsObserver extends ContentObserver {
        ...
        void observe() {
            ...
            resolver.registerContentObserver(Settings.PAC.getUriFor(
                    ...
                    UserHandle.USER_ALL);
            resolver.registerContentObserver(Settings.PAC.getUriFor(
                    Settings.PAC.HEADS_UP_BG_COLOR), false, this,
                    UserHandle.USER_ALL);
            resolver.registerContentObserver(Settings.PAC.getUriFor(
        ...
        public void onChange(boolean selfChange, Uri uri) {
            ...
            // Pie controls
                ...
                rebuildRecentsScreen();
                    ...
                    mHeadsUpCustomBg = Settings.PAC.getIntForUser(
                        mContext.getContentResolver(),
                        Settings.PAC.HEADS_UP_BG_COLOR, 0x00ffffff,
                        UserHandle.USER_CURRENT);
            } else if (uri.equals(Settings.PAC.getUriFor(
                    Settings.PAC.HEADS_UP_TEXT_COLOR))) {
                    mHeadsUpCustomText = Settings.PAC.getIntForUser(
                        mContext.getContentResolver(),
    ...
    private class TintedStatusbarObserver extends ContentObserver {
        ...
        void observe() {
            ...
            resolver.registerContentObserver(Settings.PAC.getUriFor(
                    ...
                    UserHandle.USER_ALL);
            resolver.registerContentObserver(Settings.PAC.getUriFor(
                    Settings.PAC.STATUS_BAR_TINTED_FULL_MODE), false, this,
                    UserHandle.USER_ALL);
            update();
        }
        ...
        public void update() {
            ...
            mNavbarTransparent = Settings.PAC.getIntForUser(
                    ...
                    , UserHandle.USER_CURRENT);
            mColorFullMode = (mCurrentColorProgress == 2) && (Settings.PAC.getIntForUser(
                    resolver, Settings.PAC.STATUS_BAR_TINTED_FULL_MODE, 0
                    , UserHandle.USER_CURRENT) == 1);
    ...
    protected PhoneStatusBarView makeStatusBarView() {
        ...
        if (MSimTelephonyManager.getDefault().isMultiSimEnabled()) {
            ...
            mMSimSignalClusterView.setStatusBar(this);
            ...
            mSignalClusterView.setStatusBar(this);
    ...
    private boolean isTickerEnabled() {
        return Settings.PAC.getInt(mContext.getContentResolver(),
                Settings.PAC.STATUS_BAR_TICKER_ENABLED, 1) == 1;
    }
