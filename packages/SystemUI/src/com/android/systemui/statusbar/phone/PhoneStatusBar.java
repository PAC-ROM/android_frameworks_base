...
public class PhoneStatusBar extends BaseStatusBar implements DemoMode,
    ...
    class SettingsObserver extends UserContentObserver {
        ...
        protected void observe() {
            ...
            resolver.registerContentObserver(Settings.PAC.getUriFor(
                    Settings.PAC.HEADS_UP_NOTIFICATION_DECAY), false, this,
                    UserHandle.USER_ALL);
            resolver.registerContentObserver(Settings.PAC.getUriFor(
                    Settings.PAC.NAVIGATION_BAR_BUTTON_TINT), false, this,
                    UserHandle.USER_ALL);
            resolver.registerContentObserver(Settings.PAC.getUriFor(
                    Settings.PAC.NAVIGATION_BAR_BUTTON_TINT_MODE), false, this,
                    UserHandle.USER_ALL);
            resolver.registerContentObserver(Settings.PAC.getUriFor(
                    Settings.PAC.NAVIGATION_BAR_GLOW_TINT), false, this,
                    UserHandle.USER_ALL);
            resolver.registerContentObserver(Settings.PAC.getUriFor(
                    Settings.PAC.NAVIGATION_BAR_CONFIG), false, this,
                    UserHandle.USER_ALL);
            resolver.registerContentObserver(Settings.PAC.getUriFor(
                    Settings.PAC.NAVIGATION_BAR_CAN_MOVE), false, this,
                    UserHandle.USER_ALL);
            resolver.registerContentObserver(Settings.PAC.getUriFor(
                    Settings.PAC.MENU_LOCATION), false, this,
                    UserHandle.USER_ALL);
            resolver.registerContentObserver(Settings.PAC.getUriFor(
                    Settings.PAC.MENU_VISIBILITY), false, this,
                    UserHandle.USER_ALL);
            resolver.registerContentObserver(Settings.PAC.getUriFor(
                    Settings.PAC.USE_SLIM_RECENTS), false, this,
                    UserHandle.USER_ALL);
            resolver.registerContentObserver(Settings.PAC.getUriFor(
        ...
        public void update() {
            ...
            mBlurRadius = Settings.PAC.getIntForUser(mContext.getContentResolver(),
                    Settings.PAC.LOCKSCREEN_BLUR_RADIUS,
    ...
    final private ContentObserver mHeadsUpObserver = new ContentObserver(mHandler) {
        ...
        public void onChange(boolean selfChange) {
            ...
            mHeadsUpUserEnabled = 0 != Settings.PAC.getIntForUser(
                    mContext.getContentResolver(), Settings.PAC.HEADS_UP_USER_ENABLED,
    ...
    public void start() {
        ...
        if (ENABLE_HEADS_UP) {
            ...
            mContext.getContentResolver().registerContentObserver(
                    ...
                    mHeadsUpObserver);
            mContext.getContentResolver().registerContentObserver(
                    Settings.PAC.getUriFor(Settings.PAC.HEADS_UP_USER_ENABLED), true,
                    mHeadsUpObserver);
        }
    ...
    private void createNavigationBar(Context context) {
        ...
        mNavigationBarView.updateResources(ActionHelper.getNavbarThemedResources(context));
    ...
    void updateResources(Configuration newConfig) {
        ...
        if (mNavigationBarView != null)  {
            if (updateNavBar) mNavigationBarView.updateResources(ActionHelper.getNavbarThemedResources(mContext));
            updateSearchPanel();
        }
    }
