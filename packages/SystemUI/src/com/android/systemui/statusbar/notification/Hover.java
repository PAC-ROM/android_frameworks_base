...
public class Hover {
    ...
    private void overrideShowingNotification() {
        ...
        if (isKeyguardSecureShowing() | isStatusBarExpanded()
            ...
            mNotificationView.animate().yBy(-mNotificationView.getHeight())
                    ...
                    .setListener(new AnimatorListenerAdapter() {
                        ...
                        public void onAnimationEnd(Animator animation) {
                            ...
                            if (!quit && !mVolumePanelShowing) { // else clearNotificationList() takes care
    ...
    public void setNotification(Entry entry, boolean update) {
        ...
        if (isStatusBarExpanded() | isKeyguardSecureShowing()) {
            if (mShowing) {
                dismissHover(true, true);
            } else {
                clearNotificationList();
