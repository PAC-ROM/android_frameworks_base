...
public class RecentsPanelView extends FrameLayout implements OnItemClickListener, RecentsCallback,
    ...
    public void updateValuesFromResources() {
        ...
        mThumbnailWidth = Math.round((float)res.getDimension(R.dimen.status_bar_recents_thumbnail_width) * DisplayMetrics.DENSITY_DEVICE / mAndroidDpi);
        mThumbnailHeight = Math.round((float)res.getDimension(R.dimen.status_bar_recents_thumbnail_height) * DisplayMetrics.DENSITY_DEVICE / mAndroidDpi);
