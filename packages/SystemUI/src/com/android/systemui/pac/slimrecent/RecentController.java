...
package com.android.systemui.pac.slimrecent;
    ...
    private class SettingsObserver extends ContentObserver {
        ...
        void observe() {
            ...
            resolver.registerContentObserver(Settings.PAC.getUriFor(
                    ...
                    false, this, UserHandle.USER_ALL);
            resolver.registerContentObserver(Settings.PAC.getUriFor(
                    Settings.PAC.RECENT_SHOW_RUNNING_TASKS),
                    false, this, UserHandle.USER_ALL);
            update();
        }
        ...
        public void update() {
            ...
            if (mRecentPanelView != null) {
                ...
                mRecentPanelView.setShowOnlyRunningTasks(Settings.PAC.getIntForUser(
                    resolver, Settings.PAC.RECENT_SHOW_RUNNING_TASKS, 0,
                    UserHandle.USER_CURRENT) == 1);
            }

            // Update colors in RecentPanelView
            mPanelColor = Settings.PAC.getIntForUser(resolver,
                    Settings.PAC.RECENT_PANEL_BG_COLOR, 0x00ffffff, UserHandle.USER_CURRENT);
