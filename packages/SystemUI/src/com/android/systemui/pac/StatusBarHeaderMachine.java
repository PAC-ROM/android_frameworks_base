...
public class StatusBarHeaderMachine {
        ...
        void observe() {
            mContext.getContentResolver()
                    .registerContentObserver(
                            Settings.PAC
                                    .getUriFor(Settings.PAC.STATUS_BAR_CUSTOM_HEADER),
    ...
    public void updateEnablement() {
        final boolean customHeader = Settings.PAC.getIntForUser(mContext.getContentResolver(),
                Settings.PAC.STATUS_BAR_CUSTOM_HEADER, 0,
    ...
    private IStatusBarHeaderProvider getCurrentProvider() {
        String currentProvider = Settings.PAC.getStringForUser(mContext.getContentResolver(),
                Settings.PAC.STATUS_BAR_CUSTOM_HEADER_PROVIDER,
