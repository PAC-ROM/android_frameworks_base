...
public class QSPanel extends ViewGroup {
    ...
    private class SettingsObserver extends UserContentObserver {
        ...
        protected void observe() {
            ...
            resolver.registerContentObserver(
                    Settings.PAC.getUriFor(Settings.PAC.QS_TILES_VIBRATE),
        ...
        protected void update() {
            ContentResolver resolver = mContext.getContentResolver();
            mShouldVibrate = Settings.PAC.getIntForUser(resolver,
                    Settings.PAC.QS_TILES_VIBRATE,
    ...
    private int useFourColumns() {
        ...
        mUseFourColumns = Settings.PAC.getInt(
            mContext.getContentResolver(), Settings.PAC.QS_USE_FOUR_COLUMNS,
                0) == 1;
        if (mUseFourColumns) {
            mNumberOfColumns = 4;
        } else {
