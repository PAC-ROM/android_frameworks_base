...
public class DatabaseHelper extends SQLiteOpenHelper {
    ...
    private void loadHeadsUpSetting(SQLiteStatement stmt) {
        ...
        if (!TextUtils.isEmpty(dndValues)) {
            loadSetting(stmt, Settings.PAC.HEADS_UP_NOTIFICATION, "0");
            loadSetting(stmt, Settings.PAC.HEADS_UP_CUSTOM_VALUES, dndValues);
            loadSetting(stmt, Settings.PAC.HEADS_UP_BLACKLIST_VALUES, blackListValues);
        }
    }
