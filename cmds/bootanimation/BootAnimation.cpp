...
#define USER_BOOT_MUSIC_FILE "/data/local/PowerOn.ogg"
#define SYSTEM_BOOT_MUSIC_FILE "/system/media/PowerOn.ogg"

#define USER_SHUTDOWN_MUSIC_FILE "/data/local/PowerOff.ogg"
#define SYSTEM_SHUTDOWN_MUSIC_FILE "/system/media/PowerOff.ogg"
...
bool BootAnimation::movie()
{
    ...
    timeout.tv_sec += 1; //timeout after 1s.
