...
public:
    ...
    ssize_t next()
    {
        while (true) {
            ...
            NOISY(printf("Dir %s: mcc=%d mnc=%d lang=%c%c cnt=%c%c orient=%d "
                   "ui=%d uiPac=%d density=%d touch=%d key=%d inp=%d nav=%d\n",
                   ...
                   mParams.orientation, mParams.uiMode, mParams.uiPac,
