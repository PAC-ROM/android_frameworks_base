...
public class AppTransition implements Dump {
    ...
    private class SettingsObserver extends ContentObserver {
        ...
        void observe() {
            ...
            resolver.registerContentObserver(
                    Settings.PAC.getUriFor(Settings.PAC.ANIMATION_CONTROLS_DURATION),
                    false, this);
            resolver.registerContentObserver(
                    Settings.PAC.getUriFor(Settings.PAC.ANIMATION_CONTROLS_NO_OVERRIDE),
                    false, this);
            for (int i = 0; i < 10; i++) {
              resolver.registerContentObserver(
                    Settings.PAC.getUriFor(Settings.PAC.ACTIVITY_ANIMATION_CONTROLS[i]),
                    false, this);
            }
    ...
    private void updateSettings() {
        ...
        mNoOverrides = Settings.PAC.getInt(resolver,
