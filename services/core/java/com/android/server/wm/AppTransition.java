...
public class AppTransition implements Dump {
    ...
    private class SettingsObserver extends ContentObserver {
        ...
        void observe() {
            ...
            resolver.registerContentObserver(
                    Settings.PAC.getUriFor(Settings.PAC.ANIMATION_CONTROLS_EXIT_ONLY), false, this);
            resolver.registerContentObserver(
                    Settings.PAC.getUriFor(Settings.PAC.ANIMATION_CONTROLS_REVERSE_EXIT), false, this);
            for (int i = 0; i < 11; i++) {
                resolver.registerContentObserver(
    ...
    private void updateSettings() {
        ...
        mExitOnly = Settings.PAC.getBoolean(resolver,
                Settings.PAC.ANIMATION_CONTROLS_EXIT_ONLY, true);
