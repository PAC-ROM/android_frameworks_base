...
public class PhoneWindowManager implements WindowManagerPolicy {
    ...
    private void updateKeyAssignments() {
        ...
        /* Comment this out as we don't have CM's Enable Nav Funtion
         if (mDevForceNavbar) {
        ...
        */
        ...
        final boolean hasCamera = (activeHardwareKeys & KEY_MASK_CAMERA) != 0;
    ...
    public void updateSettings() {
        ...
        synchronized (mLock) {
            ...
            mWantsNavigationBar = Settings.System.getBoolean(resolver,
                    Settings.System.ENABLE_NAVIGATION_BAR, mHasNavigationBar);
        ...
        if (mHasNavigationBar) {
            if (mNavigationBarOnBottom) {
                ...
                if (isPortrait && mUserNavBarHeight == 0
                        || !isPortrait && mUserNavBarHeightLand == 0) {
