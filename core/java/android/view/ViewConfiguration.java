    ...
    private ViewConfiguration(Context context) {
        ...
        if (Settings.PAC.getInt(resolver,
            ...
            SCROLL_FRICTION = Settings.PAC.getFloat(resolver,
                          Settings.PAC.CUSTOM_SCROLL_FRICTION, DEFAULT_SCROLL_FRICTION);
            int maximumFlingVelocity = Settings.PAC.getInt(resolver,
                          Settings.PAC.CUSTOM_FLING_VELOCITY, DEFAULT_MAXIMUM_FLING_VELOCITY);
            ...
            int overScrollDistance = Settings.PAC.getInt(resolver,
                          Settings.PAC.CUSTOM_OVERSCROLL_DISTANCE, DEFAULT_OVERSCROLL_DISTANCE);
            ...
            int overFlingDistance = Settings.PAC.getInt(resolver,
                          Settings.PAC.CUSTOM_OVERFLING_DISTANCE, DEFAULT_OVERFLING_DISTANCE);
