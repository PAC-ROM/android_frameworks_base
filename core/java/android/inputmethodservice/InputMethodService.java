...
public class InputMethodService extends AbstractInputMethodService {
    ...
    private class SettingsObserver extends ContentObserver {
        ...
        void observe() {
            getContentResolver().registerContentObserver(
                    Settings.PAC.getUriFor(Settings.PAC.ANIMATION_IME_DURATION),
                                    false, this);
            getContentResolver().registerContentObserver(
                    Settings.PAC.getUriFor(Settings.PAC.ANIMATION_IME_ENTER),
                                    false, this);
            getContentResolver().registerContentObserver(
                    Settings.PAC.getUriFor(Settings.PAC.ANIMATION_IME_EXIT),
                                    false, this);
            getContentResolver().registerContentObserver(
                    Settings.PAC.getUriFor(Settings.PAC.ANIMATION_IME_INTERPOLATOR),
                                    false, this);
    ...
    public void updateFullscreenMode() {
        boolean fullScreenOverride = Settings.PAC.getIntForUser(getContentResolver(),
                Settings.PAC.DISABLE_FULLSCREEN_KEYBOARD, 0,
    ...
    public void showWindow(boolean showInput) {
        ...
        int mKeyboardRotationTimeout = Settings.PAC.getIntForUser(getContentResolver(),
                Settings.PAC.KEYBOARD_ROTATION_TIMEOUT, 0, UserHandle.USER_CURRENT_OR_SELF);
